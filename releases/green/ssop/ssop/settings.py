...
SSOP_VERSION = '1.1.2 -- ' + datetime.datetime.utcnow().strftime('%Y.%m.%d') 
...
LAPSE_IN_APPROPRIATIONS_MESSAGE_TOP = "Parts of the U.S. government are closed. This site will not be updated; however, NOAA websites and social media channels necessary to protect lives and property will be maintained.  To learn more, visit commerce.gov."
...
AUTH_RETURN_TO = "/ssop/adminssop/sites/"
...
USER_HAS_AUTHENTICATED_SUBJECT = 'SSOP Login'
body = 'Hello firstname,\nWe noticed you logged into production SSOP admin at ymdhms.\n'
body = body + 'If you did not login at this time, please contact ' + SSOP_ADMIN_EMAIL
body = body + '\n\nYou can also direct message @Renn Valo on https://oar-gsl.slack.com'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'development_logfile': {
            ...
            'filename': '/var/log/ssoprole/ssop_dev.log',
            'formatter': 'verbose'
        },
        'info_logfile': {
            'level': 'INFO',
            'class': 'logging.FileHandler',
            'filename': '/var/log/ssoprole/ssop_info.log',
            'formatter': 'verbose'
        },
        'production_logfile': {
            'level': 'ERROR',
            ...
            'filename': '/var/log/ssoprole/ssop_production.log',
...
if SSOP_DEPLOY_ENV == "Development":
    ...
    DEPLOY_ENV_COLOR = "#0085ca"  # NOAA light blue
    DEPLOY_ENV_TEXT_COLOR = '#d3d3d3' # NOAA dark blue
    SERVER_FQDN = 'gsl-webssop.gsd.esrl.noaa.gov'
    SERVER_IP = '137.75.133.109'
else:
...
DATABASENAME = 'ssop_prod_green'
DATABASEUSERNAME = 'readwrite'
DATABASEMIGRATIONUSERNAME = 'developer'
...
DBDUMP_ROOT = '/opt/ssop/dump_green/'
...
AdminSite.site_header = 'SSOP Administration'
AdminSite.site_title = 'SSOP sites admininistration'
AdminSite.index_title = 'SSOP administration'
...
# Production oidc
LOGINDOTGOV_IDP_SERVER = 'https://secure.login.gov'
