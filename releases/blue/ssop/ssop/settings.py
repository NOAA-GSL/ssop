...
SSOPSB_VERSION = 'v2.1.0 -- ' + datetime.datetime.utcnow().strftime('%Y.%m.%d') 
...
# SSO
CSRF_TRUSTED_ORIGINS = ['https://sso.noaa.gov']
...
USER_HAS_AUTHENTICATED_SUBJECT = 'OAR SSOP Login'
body = 'Hello firstname,\nWe noticed you logged into OAR SSOP admin at ymdhms.\n'
...
USER_REMOVAL_NOTICE_SUBJECT = 'OAR Single Sign-On Portal access expiration notice'
body = 'Hello firstname,\n'
body = body + '\nYour authorized OAR Single Sign-on Portal (SSOP) projects are: project_list\n'
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'gsl.noaa.gov', SERVER_FQDN, SERVER_IP]
...
DBDUMP_ROOT = '/opt/ssop/dump_blue/'
...
AdminSite.site_header = 'OAR SSOP Administration'
AdminSite.site_title = 'OAR SSOP sites admininistration'
AdminSite.index_title = 'OAR SSOP administration'
...
LOGINDOTGOV_LOGIN_STATE = '271.82818284590452353602874'
LOGINDOTGOV_LOGOUT_STATE = '161.8033988749894848204586'
...
# Critical Weather Day display --- it is part of this app simple for convienience -- not having to duplicatate SAML and SSG understands the interface already
